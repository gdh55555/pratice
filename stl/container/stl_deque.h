    ...
    public:
        ...
        void push_back_aux(const value_type& t){
            ...
            *(finish.node + 1) = allocate_node();
            ...
            __STL_UNWIND(deallocate_node(*(finish_node + 1));
        }
...
template <class T, class Alloc, size_t BufSize>
void deque<T, Alloc, BufSize>::erase(iterator pos){
    iterator next = pos;
    ++next;
...
template <class T, class Alloc, size_t BufSize>
void deque<T, Alloc, BufSize>::insert(iterator position, const value_type& x){
