...
static ssize_t hello_read(struct file* filp, char __user *buf, size_t count, loff_t* f_ops);
static ssize_t hello_write(struct file* filp, char __user *buf, size_t count, loff_t* f_ops);
...
static size_t __hello_get_val(struct hello_android_dev* dev,char* buf){
    int val = 0;
...
static sizeof __hello_set_val(struct hello_android_dev* dev, const char* buf, size_t count){
    int val = 0;
